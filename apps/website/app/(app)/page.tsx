	...
	return (
		<PageCard>
			...
			<PageHeading heading={"h1"}>
				Welcome to community building homepage!
			</PageHeading>
			<p>
				Here is some information about community building on the Connect
				Utah Today site.
			</p>
			...
			<div className={styles.objectives}>
				...
				<ul className={styles.objectivesList}>
					<li className={styles.objectivesItem}>
						...
						discuss politics, activism, and other shared interests.
					</li>
					<li className={styles.objectivesItem}>
						<span className={styles.objectivesBullet}>•</span>
