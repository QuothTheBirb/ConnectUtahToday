...
export default function SupportPage() {
	return (
		<PageCard>
			...
			>
				Below are causes endorsed by local organizations which you may
				choose to donate to. Click on a widget to learn more about the
				individual causes.{" "}
			...
			<DisclaimerPopup>
				<p>
					...
					links to third-party charitable organizations for your
					convenience. We do not collect or process donations
					directly; all donations are handled by the respective
					organizations. The inclusion of any link does not imply
					endorsement or recommendation. We make no representations
					about the accuracy or completeness of the information
					provided. By clicking on a donation link, you will leave our
					website and be subject to the policies and terms of the
					third-party site. Connect Utah Today is not responsible for
					the content or privacy practices of any linked site. This
					site does not provide legal, tax, or financial advice—please
					consult with an appropriate professional before making a
					donation or regarding the tax deductibility of your
					contribution.
				</p>
			</DisclaimerPopup>
		</PageCard>
